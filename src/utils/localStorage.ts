...
const themeModKey = "themeMode"

export const setThemeModeToLocalStorage = (mode: PaletteMode) => {
  localStorage.setItem(themeModKey, mode);
}

export const getThemeModeFromLocalStorage = (): PaletteMode | undefined => {
  return localStorage.getItem(themeModKey) as PaletteMode;
}
